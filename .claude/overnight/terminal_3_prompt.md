# AutoResearch Session: RESEARCHER
# Terminal: 3
...
```bash
# 1. Create branch
git checkout -b autoresearch/researcher/overnight-2026-03-22
...
```bash
cat .claude/overnight/commands/terminal_3_queue.json 2>/dev/null || echo '{"commands":[]}'
```
