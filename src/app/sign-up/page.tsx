...
import { signUp, signInWithGoogle, handleRedirectResult } from '@/lib/firebase-client';
  ...
  return (
    <>
      <style>{`
        ...
        .su-strength-seg.active-1 { background: #ef4444; }
        .su-strength-seg.active-2 { background: #f97316; }
        .su-strength-seg.active-3 { background: #eab308; }
        .su-strength-seg.active-4 { background: #22c55e; }
        ...
        .su-strength-label.s1 { color: #ef4444; }
        .su-strength-label.s2 { color: #f97316; }
        .su-strength-label.s3 { color: #eab308; }
        .su-strength-label.s4 { color: #22c55e; }
      ...
      <div className="su-root">
        <div className="su-container">
          ...
          <div className="su-logo">
            <div className="su-logo-emblem">
              <svg viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="5" y="8" width="4" height="12" rx="1.5" fill="url(#sg1)" opacity="0.9"/>
                <rect x="6.5" y="4" width="1" height="4" rx="0.5" fill="url(#sg1)" opacity="0.7"/>
                <rect x="6.5" y="20" width="1" height="4" rx="0.5" fill="url(#sg1)" opacity="0.7"/>
                <rect x="12" y="5" width="4" height="10" rx="1.5" fill="url(#sg2)" opacity="0.9"/>
                <rect x="13.5" y="2" width="1" height="3" rx="0.5" fill="url(#sg2)" opacity="0.7"/>
                <rect x="13.5" y="15" width="1" height="3" rx="0.5" fill="url(#sg2)" opacity="0.7"/>
                <rect x="19" y="11" width="4" height="9" rx="1.5" fill="url(#sg1)" opacity="0.9"/>
                <rect x="20.5" y="7" width="1" height="4" rx="0.5" fill="url(#sg1)" opacity="0.7"/>
                <rect x="20.5" y="20" width="1" height="3" rx="0.5" fill="url(#sg1)" opacity="0.7"/>
                <defs>
            ...
            <h1 className="su-logo-title">SwjshAK</h1>
            <p className="su-logo-subtitle">Algorithmic Trading Platform</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="su-form">
                  ...
                  <>
                    <div className="su-strength-wrap">
                      {[1,2,3,4].map((seg) => (
                        <div
                          key={seg}
                          className={`su-strength-seg ${pwStrength >= seg ? `active-${pwStrength}` : ''}`}
                        />
                      ))}
                    </div>
                    <div className={`su-strength-label s${pwStrength}`}>
                      {pwStrength === 1 ? 'Too weak' : pwStrength === 2 ? 'Fair' : pwStrength === 3 ? 'Good' : 'Strong'}
                    </div>
                  </>
                )}
              </div>
              ...
              <div className="su-field">
                ...
                {confirmPassword.length > 0 && (
                  <div className={`su-match-indicator ${password === confirmPassword ? 'su-match-ok' : 'su-match-err'}`}>
